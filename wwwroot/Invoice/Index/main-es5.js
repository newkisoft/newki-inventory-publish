...
var InvoiceDocumentFile = /** @class */ (function () {
    function InvoiceDocumentFile() {
        this.InvoiceId = 0;
        this.DocumentFileId = 0;
    }
    return InvoiceDocumentFile;
}());
...
var InvoicePayment = /** @class */ (function () {
...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this.http.get(invoiceUrl + this.id)
            ...
            _this.customerSearchText = _this.invoice.Customer.CustomerName;
        ...
        this.http.get(this.exchangeApi)
            .subscribe(function (p) {
            _this.newInvoicePayment.ExchangeRate = _this.ExchangeRate;
        });
    ...
    EditComponent.prototype.Add = function (newPalletId) {
        ...
        this.Calculate();
        var index = this.pallets.indexOf(selectedPallet);
        if (index !== -1) {
    ...
    EditComponent.prototype.SendEmail = function () {
        var _this = this;
        this.showSuccess = false;
    ...
    EditComponent.prototype.AddPallet = function (newPalletId) {
        var selectedPallet = this.pallets.find(function (p) { return p.PalletId == newPalletId; });
        var newInvoicePallet = new _InvoicePallet__WEBPACK_IMPORTED_MODULE_10__["InvoicePallet"]();
        newInvoicePallet.PalletId = selectedPallet.PalletId;
        newInvoicePallet.Pallet = selectedPallet;
    ...
    EditComponent.prototype.AddCustomer = function (newCustomerId) {
        this.invoice.Customer = this.customers.find(function (p) { return p.CustomerId == newCustomerId; });
        this.customerAutocomplete = "list-group collapse hide";
    ...
    EditComponent.prototype.RemoveSearchPalletItem = function (selectedPallet) {
        var index = this.pallets.indexOf(selectedPallet);
        if (index !== -1) {
            this.pallets.splice(index, 1);
        }
    };
    EditComponent.prototype.RemoveSearchBoxItem = function (selectedBox) {
        var index = this.boxes.indexOf(selectedBox);
        if (index !== -1) {
    ...
    EditComponent.prototype.OnUploadFile = function () {
        ...
        this.http
            ...
            newInvoiceFile.InvoiceId = Number(_this.id);
        ...
        if (this.boxSearchText.length < 1) {
            ...
            if (this.boxSearchText.length >= 26) {
                ...
                this.boxes.forEach(function (p) {
                    if (_this.boxSearchText.includes(p.Barcode)) {
                        _this.AddBox(p.BoxId);
                        cnt++;
                    }
                });
                this.boxSearchText = '';
    ...
    EditComponent.prototype.customerSearchChange = function () {
        this.customerAutocomplete = "list-group collapse show";
    };
    EditComponent.prototype.palletSearchChange = function () {
        var _this = this;
        if (this.palletSearchText.length < 1) {
            ...
            if (this.palletSearchText.length >= 26) {
                ...
                this.pallets.forEach(function (p) {
                    if (_this.palletSearchText.includes(p.Barcode)) {
                        _this.AddPallet(p.PalletId);
                        cnt++;
                    }
                });
                this.palletSearchText = '';
    ...
    EditComponent.prototype.AddPayment = function () {
        var _this = this;
    ...
    EditComponent.prototype.RemovePayment = function (selectedInvoice) {
        var index = this.invoice.Payments.indexOf(selectedInvoice);
        if (index !== -1) {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.Sync = function () {
        var _this = this;
        this.syncing = true;
...
var InsertComponent = /** @class */ (function () {
    ...
    InsertComponent.prototype.AddPallet = function (newPalletId) {
        var selectedPallet = this.pallets.find(function (p) { return p.PalletId == newPalletId; });
    ...
    InsertComponent.prototype.AddCustomer = function (newCustomerId) {
        this.invoice.Customer = this.customers.find(function (p) { return p.CustomerId == newCustomerId; });
        this.customerAutocomplete = "list-group collapse hide";
        this.customerSearchText = this.invoice.Customer.CustomerName;
    };
    ...
    InsertComponent.prototype.RemoveSearchBoxItem = function (selectedBox) {
        var index = this.boxes.indexOf(selectedBox);
        if (index !== -1) {
            this.boxes.splice(index, 1);
        }
    };
    InsertComponent.prototype.RemoveSearchPalletItem = function (selectedPallet) {
        var index = this.pallets.indexOf(selectedPallet);
        if (index !== -1) {
            this.pallets.splice(index, 1);
        }
    ...
    InsertComponent.prototype.SelectCustomer = function (option) {
        this.invoice.Customer = option;
    };
    InsertComponent.prototype.SelectDate = function (option) {
        this.invoice.InvoiceDate = option;
    };
    InsertComponent.prototype.ToggleShowCustomers = function () {
    ...
    InsertComponent.prototype.palletSearchChange = function () {
        var _this = this;
        if (this.palletSearchText.length < 1) {
            this.palletAutocomplete = "list-group collapse hide";
        }
    ...
    InsertComponent.prototype.customerSearchChange = function () {
        this.customerAutocomplete = "list-group collapse show";
    };
    InsertComponent.prototype.AddPayment = function () {
        if (this.invoice.Payments == null)
            this.invoice.Payments = new Array();
    ...
    InsertComponent.prototype.RemovePayment = function (selectedInvoice) {
        var index = this.invoice.Payments.indexOf(selectedInvoice);
        if (index !== -1) {
            this.invoice.Payments.splice(index, 1);
            this.invoice.Paid = this.invoice.Paid - selectedInvoice.Amount / selectedInvoice.ExchangeRate;
