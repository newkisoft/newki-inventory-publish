...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.Save = function (pallet) {
        var _this = this;
        this.showSuccess = false;
        this.saving = true;
    ...
    EditComponent.prototype.Warehouse = function (location) {
        this.pallet.Warehouse = location;
        this.showWareHouseOptions = !this.showWareHouseOptions;
    };
    EditComponent.prototype.OnUploadFile = function (imageType) {
        var _this = this;
        if (imageType == 'image') {
        ...
        var formModel = this.form.value.image;
        this.uploading = true;
        ...
        this.http
            ...
            .then(function () {
            if (imageType == 'image') {
                _this.pallet.Image = _this.form.value.image.filename;
            }
            else {
                _this.pallet.ThumbnailImage = _this.form.value.image.filename;
            }
...
var IndexComponent = /** @class */ (function () {
    function IndexComponent(http, router, route) {
        this.http = http;
        this.router = router;
        this.route = route;
    ...
    IndexComponent.prototype.ngOnInit = function () {
        ...
        this.http
            ...
            .toPromise()
            .then(function (res) {
            _this.colorAlerts = res;
        });
        this.http
            .get(this.filtersURL)
            .toPromise()
            .then(function (res) {
            _this.filterOptions = res;
        });
    };
    IndexComponent.prototype.Export = function () {
        var _this = this;
    ...
    IndexComponent.prototype.singleClick = function (event) {
        var _this = this;
        this.preventSingleClick = false;
        var delay = 200;
    ...
    IndexComponent.prototype.doubleClick = function (event) {
    ...
    IndexComponent.prototype.calculateTotalWeight = function () {
        this.totlWeight = 0;
    ...
    IndexComponent.prototype.Sort = function (sortHeader) {
        switch (sortHeader) {
            case 'PalletNumber':
                {
                    this.sortUp[0] = !this.sortUp[0];
                    if (this.sortUp[0]) {
                        this.filteredPallets.sort(function (a, b) { return a.PalletNumber - b.PalletNumber; });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.PalletNumber - a.PalletNumber; });
                    }
                    break;
                }
            case 'Barcode':
                {
                    ...
                    if (this.sortUp[1]) {
                        this.filteredPallets.sort(function (a, b) { return a.Barcode.localeCompare(b.Barcode); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.Barcode.localeCompare(a.Barcode); });
                    }
                    break;
                }
            case 'YarnType':
                {
                    ...
                    if (this.sortUp[1]) {
                        this.filteredPallets.sort(function (a, b) { return a.YarnType.localeCompare(b.YarnType); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.YarnType.localeCompare(a.YarnType); });
                    }
                    break;
                }
            case 'Denier':
                {
                    ...
                    if (this.sortUp[3]) {
                        this.filteredPallets.sort(function (a, b) { return a.Denier - b.Denier; });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.Denier - a.Denier; });
                    }
                    break;
                }
            case 'Filament':
                {
                    ...
                    if (this.sortUp[4]) {
                        this.filteredPallets.sort(function (a, b) { return a.Filament - b.Filament; });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.Filament - a.Filament; });
                    }
                    break;
                }
            case 'Lustre':
                {
                    ...
                    if (this.sortUp[5]) {
                        this.filteredPallets.sort(function (a, b) { return a.Lustre && b.Lustre && a.Lustre.localeCompare(b.Lustre); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return a.Lustre && b.Lustre && b.Lustre.localeCompare(a.Lustre); });
                    }
                    break;
                }
            case 'Intermingle':
                {
                    ...
                    if (this.sortUp[6]) {
                        this.filteredPallets.sort(function (a, b) { return a.Intermingle && b.Intermingle && a.Intermingle.localeCompare(b.Intermingle); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return a.Intermingle && b.Intermingle && b.Intermingle.localeCompare(a.Intermingle); });
                    }
                    break;
                }
            case 'Color':
                {
                    ...
                    if (this.sortUp[7]) {
                        this.filteredPallets.sort(function (a, b) { return a.Color && b.Color && a.Color.localeCompare(b.Color); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return a.Color && b.Color && b.Color.localeCompare(a.Color); });
                    }
                    break;
                }
            case 'ColorCode':
                {
                    ...
                    if (this.sortUp[8]) {
                        this.filteredPallets.sort(function (a, b) { return a.ColorCode && b.ColorCode && a.ColorCode.localeCompare(b.ColorCode); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return a.ColorCode && b.ColorCode && b.ColorCode.localeCompare(a.ColorCode); });
                    }
                    break;
                }
            case 'BobbinSize':
                {
                    ...
                    if (this.sortUp[9]) {
                        this.filteredPallets.sort(function (a, b) { return a.BobbinSize && b.BobbinSize && a.BobbinSize.localeCompare(b.BobbinSize); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return a.BobbinSize && b.BobbinSize && b.BobbinSize.localeCompare(a.BobbinSize); });
                    }
                    break;
                }
            case 'Weight':
                {
                    ...
                    if (this.sortUp[10]) {
                        this.filteredPallets.sort(function (a, b) { return a.Weight - b.Weight; });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.Weight - a.Weight; });
                    }
                    break;
                }
            case 'RemainWeight':
                {
                    ...
                    if (this.sortUp[11]) {
                        this.filteredPallets.sort(function (a, b) { return a.RemainWeight - b.RemainWeight; });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.RemainWeight - a.RemainWeight; });
                    }
                    break;
                }
            case 'Sold':
                {
                    ...
                    if (this.sortUp[12]) {
                        this.filteredPallets.sort(function (a, b) { return a.Sold.toString().localeCompare(b.Sold.toString()); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.Sold.toString().localeCompare(a.Sold.toString()); });
                    }
                    break;
                }
            case 'Lot':
                {
                    ...
                    if (this.sortUp[13]) {
                        this.filteredPallets.sort(function (a, b) { return a.Lot.localeCompare(b.Lot); });
                    }
                    else {
                        this.filteredPallets.sort(function (a, b) { return b.Lot.localeCompare(a.Lot); });
                    }
                    break;
                }
        }
    };
    IndexComponent.prototype.filterBy = function (keyword) {
        var _this = this;
        this.progress = "progress-bar progress-bar-striped progress-bar-animated w-0";
        this.progressPercent = 0;
        ...
        this.http
            ...
            .toPromise()
            .then(function (res) {
            _this.progress = "progress-bar progress-bar-striped progress-bar-animated w-85";
            _this.progressPercent = 85;
            _this.pallets = res;
            _this.filteredPallets = _this.pallets;
            _this.calculateTotalWeight();
            _this.isLoading = false;
            _this.progress = "progress-bar progress-bar-striped progress-bar-animated w-100";
            _this.progressPercent = 100;
        });
    };
    IndexComponent.prototype.ChangeBulkUpdateDialogue = function () {
    ...
    IndexComponent.prototype.ChangeWarehouse = function (warehosue) {
        this.bulkWarehouse = warehosue;
        this.showWareHouseOptions = !this.showWareHouseOptions;
    };
    IndexComponent.prototype.Publish = function () {
        var _this = this;
    ...
    IndexComponent.prototype.BulkUpdate = function () {
        var _this = this;
        this.saving = true;
    ...
    IndexComponent.prototype.RemoveFilter = function (filter) {
        var _this = this;
...
var InsertComponent = /** @class */ (function () {
    ...
    InsertComponent.prototype.Save = function (pallet) {
        var _this = this;
        this.showSuccess = false;
        this.saving = true;
    ...
    InsertComponent.prototype.Warehouse = function (location) {
        this.pallet.Warehouse = location;
    };
