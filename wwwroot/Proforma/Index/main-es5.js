...
var ProformaDocumentFile = /** @class */ (function () {
    function ProformaDocumentFile() {
        this.ProformaId = 0;
        this.DocumentFileId = 0;
    }
    return ProformaDocumentFile;
}());
...
var ProformaProformaItem = /** @class */ (function () {
    function ProformaProformaItem() {
        this.Weight = 0;
        this.Price = 0;
        this.ProformaId = 0;
        this.ProformaItemId = 0;
    }
    return ProformaProformaItem;
}());
...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this.http.get(proformaItemUrl)
            .subscribe(function (p) {
            _this.ProformaItems = p.Items;
            _this.filteredProformas = p.Items;
        ...
        this.http.get(proformaUrl + this.id)
            ...
            for (var i = 0; i < p.ProformaProformaItems.length; i++) {
                _this.proformaProformaItems.push(p.ProformaProformaItems[i]);
            }
            for (var i = 0; i < p.Files.length; i++) {
                _this.files.push(p.Files[i]);
            }
            _this.ExchangeRate = _this.proforma.ExchangeRate;
            _this.TotalUsd = _this.proforma.TotalUsd;
            _this.Tax = _this.proforma.Tax;
            _this.Calculate();
        });
        this.ProformaReportUrl = "/ProformaReport/print/?id=" + this.id;
    };
    EditComponent.prototype.Add = function (newProformaId) {
        var selectedProformaItem = this.ProformaItems.find(function (p) { return p.ProformaItemId == newProformaId; });
    ...
    EditComponent.prototype._filter = function (value) {
        ...
        return this.ProformaItems.filter(function (option) { return option.ProformaItemId.toString().includes(filterValue) ||
    ...
    EditComponent.prototype.RemoveItem = function (selectedProforma) {
        var index = this.proformaProformaItems.indexOf(selectedProforma);
        if (index !== -1) {
    ...
    EditComponent.prototype.Save = function (proforma) {
        var _this = this;
        this.Calculate();
        this.showSuccess = false;
        this.saving = true;
    ...
    EditComponent.prototype.OnUploadFile = function () {
        ...
        this.http
            ...
            newProformaFile.ProformaId = Number(_this.id);
            ...
            _this.files.push(newProformaFile);
    ...
    EditComponent.prototype.searchChange = function () {
    ...
    EditComponent.prototype.AddNewItem = function () {
        var proformaProformaItem = new _ProformaProformaItem__WEBPACK_IMPORTED_MODULE_9__["ProformaProformaItem"]();
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getColor = function (proforma) {
    ...
    HomeComponent.prototype.getDifference = function (proforma) {
        var lira = proforma.TotalUsd * proforma.ExchangeRate;
        var diffLira = proforma.Paid - lira;
        var diffUsd = proforma.Paid - proforma.TotalUsd;
        if (proforma.Currency === 'Lira')
    ...
    HomeComponent.prototype.calculateTotalWeight = function () {
        this.totalPaid = 0;
        this.totalDebt = 0;
            ...
            case 'ProformaId':
                {
                    ...
                    if (this.sortUp[0]) {
                        this.proformas.sort(function (a, b) { return a.ProformaId - b.ProformaId; });
                    }
                    else {
                        this.proformas.sort(function (a, b) { return b.ProformaId - a.ProformaId; });
                    }
                    break;
                }
            case 'CustomerName':
                {
                    ...
                    if (this.sortUp[1]) {
                        this.proformas.sort(function (a, b) { return a.Customer.CustomerName.toLocaleLowerCase().localeCompare(b.Customer.CustomerName.toLocaleLowerCase()); });
                    }
                    else {
                        this.proformas.sort(function (a, b) { return b.Customer.CustomerName.toLocaleLowerCase().localeCompare(a.Customer.CustomerName.toLocaleLowerCase()); });
                    }
                    break;
                }
            case 'ProformaDate':
                {
                    ...
                    if (this.sortUp[2]) {
                        this.proformas.sort(function (a, b) { return a.ProformaDate.localeCompare(b.ProformaDate); });
                    }
                    else {
                        this.proformas.sort(function (a, b) { return b.ProformaDate.localeCompare(a.ProformaDate); });
                    }
                    break;
                }
            case 'TotalUsd':
                {
                    ...
                    if (this.sortUp[4]) {
                        this.proformas.sort(function (a, b) { return a.TotalUsd - b.TotalUsd; });
                    }
                    else {
                        this.proformas.sort(function (a, b) { return b.TotalUsd - a.TotalUsd; });
                    }
                    break;
                }
            case 'Paid':
                {
                    ...
                    if (this.sortUp[5]) {
                        this.proformas.sort(function (a, b) { return a.Paid - b.Paid; });
                    }
                    else {
                        this.proformas.sort(function (a, b) { return b.Paid - a.Paid; });
                    }
                    break;
                }
        }
...
var InsertComponent = /** @class */ (function () {
    ...
    InsertComponent.prototype.createForm = function () {
        this.form = this.fb.group({
            name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            fatura: null
        });
    ...
    InsertComponent.prototype.Add = function (newProformaId) {
        var selectedProformaItem = this.ProformaItems.find(function (p) { return p.ProformaItemId == newProformaId; });
        var newProformaProformaItem = new _ProformaProformaItem__WEBPACK_IMPORTED_MODULE_9__["ProformaProformaItem"]();
        newProformaProformaItem.ProformaItemId = selectedProformaItem.ProformaItemId;
        newProformaProformaItem.ProformaItem = selectedProformaItem;
    ...
    InsertComponent.prototype.Delete = function () {
        var _this = this;
        this.showSuccess = false;
        var invoiceUrl = "/api/Proforma/Delete/?proformaId=" + this.proforma.ProformaId;
        this.http
    ...
    InsertComponent.prototype.RemoveItem = function (selectedProforma) {
        var index = this.proformaProformaItems.indexOf(selectedProforma);
        if (index !== -1) {
            this.proformaProformaItems.splice(index, 1);
        }
    ...
    InsertComponent.prototype.Save = function (proforma) {
        var _this = this;
        this.Calculate();
        this.showSuccess = false;
        this.saving = true;
    ...
    InsertComponent.prototype.OnUploadFile = function () {
        var _this = this;
    ...
    InsertComponent.prototype.onFileChange = function (event) {
        var _this = this;
        var reader = new FileReader();
        if (event.target.files && event.target.files.length > 0) {
            var file_1 = event.target.files[0];
    ...
    InsertComponent.prototype.RemoveFileItem = function (selectedFile) {
        var index = this.files.indexOf(selectedFile);
        if (index !== -1) {
            this.files.splice(index, 1);
        }
    ...
    InsertComponent.prototype.searchChange = function () {
        if (this.searchText.length < 1) {
            this.autocomplete = "list-group collapse hide";
        }
        else {
    ...
    InsertComponent.prototype.AddNewItem = function () {
        var proformaProformaItem = new _ProformaProformaItem__WEBPACK_IMPORTED_MODULE_9__["ProformaProformaItem"]();
        var proformaItem = new _ProformaItem_ProformaItem_src_app_ProformaItem__WEBPACK_IMPORTED_MODULE_12__["ProformaItem"]();
        proformaItem.Description = this.searchText;
        proformaItem.ProformaItemId = -1;
